...
public class MotionPoints {		
    ...
    public static BufferedTrajectoryPointStream pointStream = writeToStream(false);
    static int kPrimaryPIDSlot = 0;
    static int kSensorUnitsPerRotation = 0;

    public static BufferedTrajectoryPointStream writeToStream(boolean reversed){
        ...
        for (int i = 0; i < points.length; i++) {
            ...
            point.position = direction * positionRot * kSensorUnitsPerRotation;           // Convert Revolutions to Units
            point.velocity = direction * velocityRPM * kSensorUnitsPerRotation / 600.0;   // Convert RPM to Units/100ms
            point.auxiliaryPos = 0;
            point.auxiliaryVel = 0;
            point.profileSlotSelect0 = kPrimaryPIDSlot; /* which set of gains would you like to use [0,3]? */
            point.profileSlotSelect1 = 0; /* auxiliary PID [0,1], leave zero */
            point.zeroPos = (i == 0); /* set this to true on the first point */
            point.isLastPoint = ((i + 1) == points.length); /* set this to true on the last point */
            point.arbFeedFwd = 0.3; /* you can add a constant offset to add to PID[0] output here */

            System.out.println(bufferedStream.Write(point));
